...
public class AssetListFragment extends Fragment {
    ...
    public static AssetListFragment newInstance(){return new AssetListFragment();}
    ...
    private class FetchItemsTask extends AsyncTask<Void,Void,String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            return new OKHttpFetch(getActivity()).get("/voucher/android/getAll.do?limit=10&offset=0");
        }
